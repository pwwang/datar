...
from datar2.base.constants import letters
...
def test_nzchar():
    ...
    assert_iterable_equal(nzchar(['1', np.nan], na_as=True), [True, True])
...
def test_substr():
    ...
    assert_iterable_equal(substr(['abce', 'efgh', np.nan], 1, 3), ['bc', 'fg', np.nan])
