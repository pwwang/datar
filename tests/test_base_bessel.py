...
@pytest.mark.parametrize('x,nu,exp', [
...
@pytest.mark.parametrize('x,nu,expon_scaled,exp', [
    ([0,1,2,3,NA], 0, True, [1,0.46575961,0.30850832,0.2430004,NA]),
    ([0,1,2,3,NA], 1, True, [0,0.20791042,0.21526929,0.1968267,NA]),
    ([0,1,2,3,NA], 2, True, [0,0.04993878,0.09323903,0.1117825,NA]),
...
@pytest.mark.parametrize('x,nu,expon_scaled,exp', [
    ([0,1,2,3,NA], 0, True, [Inf,1.14446307980689,0.841568215070772,0.697761598043852,NA]),
    ([0,1,2,3,NA], 1, True, [Inf,1.63615348626326,1.03347684706869,0.806563480128787,NA]),
    ([0,1,2,3,NA], 2, True, [Inf,4.41677005233341,1.87504506213946,1.23547058479638,NA]),
    ([0,1,2,3,NA], 0, False, [Inf,0.421024438240708,0.113893872749533,0.0347395043862793,NA]),
    ([0,1,2,3,NA], 1, False, [Inf,0.601907230197235,0.139865881816522,0.0401564311281942,NA]),
    ([0,1,2,3,NA], 2, False, [Inf,1.62483889863518,0.253759754566056,0.061510458471742,NA])
])
